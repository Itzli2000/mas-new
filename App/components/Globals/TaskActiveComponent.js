...
import { NewPhotoComponent } from '@bm-mas-global-components';
...
class TasksActiveComponent extends Component {
  ...
  render() {
    const { props } = this;
    return (
        <View style={[ props.showTaskComponent ? styles.show : styles.hide, styles.componentContainer ]}>
          <View style={[styles.taskActiveContainer, styles.spaceElement]}>
            ...
            <View style={[styles.centered]}>
              ...
              <View style={[styles.row, styles.centered]}>
                <TouchableOpacity activeOpacity = { .5 } onPress={()=>props.hideTaskComponent()}>
